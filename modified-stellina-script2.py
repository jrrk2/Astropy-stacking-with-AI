...
def process_directory(src_dir, base_dir='lights', target_name=None, max_separation_deg=1.0, 
    ...
    # Check for observation.json in the source directory and load transformation data
    observation_json_path = Path(src_dir) / "observation.json"
    transformations = None
    if observation_json_path.exists() and add_registration:
        print(f"Found observation.json: {observation_json_path}")
