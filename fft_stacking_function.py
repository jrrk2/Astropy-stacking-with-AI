def progressive_stack_fft(self, filtered_frames):
    """
    Progressively stack frames using enhanced FFT alignment
...
def process_with_fft(self, output_path='stacked_fft_image.fits'):
    """
    Process pipeline using FFT alignment - ideal for faint targets
    ...
    # Perform FFT-based progressive stacking
    stacked_image, alignment_info, rejected_frames = self.progressive_stack_fft(filtered_frames)
