...
if __name__ == "__main__":
    ...
    # Unpack results
    processed, skipped, errors = results[0], results[1], results[2]
    calibrated = results[3] if len(results) > 3 else 0
    registration_added = results[4] if len(results) > 4 else 0
    registration_failed = results[5] if len(results) > 5 else 0
