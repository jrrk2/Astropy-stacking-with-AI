...
from astroquery.apass import APASS
import os
...
[Previous get_catalog_stars, perform_photometric_calibration, and eliminate_background_wavelet functions remain the same]
