...
# Function to apply adaptive stretch
def adaptive_stretch(image, black_point=0.01, white_point=0.9999, gamma=0.4):
    """
    Apply an adaptive stretch with improved visibility
    ...
    black_point : float, optional
        Percentile to use as black point (default: 0.01)
    white_point : float, optional
        Percentile to use as white point (default: 0.9999)
    gamma : float, optional
        Gamma correction factor (default: 0.4)
    ...
    # Calculate black and white points with more aggressive percentiles
