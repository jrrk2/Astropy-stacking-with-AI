...
def process_single_frame(filename, ref_wcs, ref_shape, dark_manager):
    """Process a single frame with optimized memory usage"""
    ...
    try:
        ...
        with fits.open(solved_file, memmap=True) as hdul:
            ...
            for idx, color in enumerate(['R', 'G', 'B']):
                ...
                results[color] = reprojected.copy()  # Make a copy to ensure we don't hold references
...
class MmapStacker:
    ...
    def process_files(self, files):
        ...
        for color in ['R', 'G', 'B']:
            ...
            del temp_array  # Free memory
        
        # Process files in smaller batches
        batch_size = min(5, len(files))  # Reduced batch size
        processed_count = 0
                    ...
                    try:
                        ...
                        if result is not None:
                            ...
                            for color in ['R', 'G', 'B']:
                                ...
                                del result[color]  # Free memory as we go
                    except Exception as e:
