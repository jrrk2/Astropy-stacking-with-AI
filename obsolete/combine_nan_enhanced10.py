...
def save_16bit_png(data, filename):
    """
    Save a normalized 16-bit PNG with file size management
    ...
    # Use PIL for more controlled PNG export
    from PIL import Image
    
    # Convert to PIL Image
    pil_image = Image.fromarray(scaled_data, mode='I;16')
    
    # Save with compression
    pil_image.save(filename, compress_level=9)
