(* FFT-based image alignment using Owl library *)
open Printf
open Types
...
let align_with_fft ref_data img_data width height =
  (* Compute cross-correlation using Owl *)
  let corr = OwlFFT.cross_correlation ref_data img_data width height in
...
(* Improved align_image function with sub-pixel accuracy using Owl *)
...
(* Update align_images to use Owl-based FFT alignment *)
