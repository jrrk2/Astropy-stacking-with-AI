...
def combine_rgb_channels(r_filename, g_filename, b_filename, output_base, 
    ...
    # Create separate 16-bit channels for PIL
    r_channel = Image.fromarray(rgb_png[..., 0], mode='I')
    g_channel = Image.fromarray(rgb_png[..., 1], mode='I')
    b_channel = Image.fromarray(rgb_png[..., 2], mode='I')
